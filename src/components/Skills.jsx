      ...
      <div className="max-w-screen-xl mx-auto px-6 flex flex-col justify-center h-full">
        ...
        <div className="pb-12 text-center md:text-left">
          ...
          <p className="py-6 text-muted-foreground text-lg max-w-2xl">
            ...
            <span className="text-white font-bold">Modern Web Infrastructure</span>.
          </p>
        </div>
            ...
            >
              <SpotlightCard className="p-8 h-full flex flex-col">
                ...
                <div className="flex items-center gap-4 mb-6 border-b border-white/10 pb-4">
                  <span className="text-[#38bdf8] bg-[#38bdf8]/10 p-3 rounded-xl border border-[#38bdf8]/20">
                    {category.icon}
                  </span>
                ...
                <div className="flex flex-wrap gap-3">
                  {category.skills.map((skill, i) => (
                    ...
                    >
                      ...
                      <div className="absolute -inset-0.5 bg-[#38bdf8]/30 rounded-full blur opacity-0 group-hover:opacity-75 transition duration-200"></div>
